...
gndTruth = list(sio.loadmat('basetest.mat')['label'])
...
prednum2 = np.array(sio.loadmat('basetestresnoov2.mat')['data'])[0]
scr2 = np.array(sio.loadmat('basetestresnoov2.mat')['scr'])[0]
prednum = np.array(sio.loadmat('basetestres6_2.mat')['data'])[0]
scr = np.array(sio.loadmat('basetestres6_2.mat')['scr'])[0]
# prednum3 = np.array(sio.loadmat('basetestgbn.mat')['data'])[0]
# scr3 = np.array(sio.loadmat('basetestgbn.mat')['scr'])[0]

prednum1k = np.array(sio.loadmat('basetestres1k2.mat')['data'])[0]
scr1k = np.array(sio.loadmat('basetestres1k2.mat')['scr'])[0]
