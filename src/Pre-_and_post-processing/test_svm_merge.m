...
for i=1:length(unique_template_id_probe)
    ...
    pair_1_model_name = strcat('probe\IJBA_split1_svm_model_', num2str(pair_1_id), '.mat');
    ...
    for j = 1:length(unique_template_id_gallery)
        ...
        pair_2_model_name = strcat('gallery2\IJBA_split1_svm_model_', num2str(pair_2_id), '.mat');
