...
for i=1:size(PROBE,1)
    ...
    pair_1_model_name = strcat('/home/zhaojian/liblinear-2.1/matlab/SVMmodels_split2/IJBA_split2_svm_model_', num2str(pair_1), '.mat'); % Load svm
    pair_2_model_name = strcat('/home/zhaojian/liblinear-2.1/matlab/SVMmodels_split2/IJBA_split2_svm_model_', num2str(pair_2), '.mat');
