...
im2rec_path='/home/zhaojian/Softwares/mxnet-master/tools'
...
python $im2rec_path/im2rec.py /home/zhaojian/Documents/Projects/facenet/models/GoogleNet/lfw_list.lst ./ --resize=${SHAPE} --quality=${QUALITY} --color=1 --shuffle=False --center-crop=True
